...
from train_models.prioritized_replay_memory import PrioritizedReplayMemory
...
class Normalizer(object):
    ...
    def normalize(self, x):
        ...
        # print("normalize.mean:", self.mean)
...
class DDPG(object):
    ...
    def _sample_batch(self):
        ...
        print("sample size: ", self.batch_size)
    ...
    def update(self):
        ...
        return loss.item(), policy_loss.item() #okk
    ...
    def choose_action(self, x):
        ...
        if self.ouprocess:
            ...
            action += torch.randn(self.n_actions).numpy()
    ...
    def save_model(self, model_dir, title):
        ...
        print("模型保存：", '{}/{}_actor.pth'.format(model_dir, title))

        torch.save(
            self.actor.state_dict(), '{}/{}_actor.pth'.format(model_dir, title)
        )
